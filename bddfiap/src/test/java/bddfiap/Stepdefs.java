...
public class Stepdefs {
    ...
    @Given("Que cliente {string} VISITA a pagina do site com a senha {string} como {string}")
    ...
    @When("O cliente pesquisa por um produto {string}")
    ...
    @Then("Deve ser consultado o estoque do produto {string}")
    ...
    @Then("Retornar a quantidade de Produtos {string} Disponiveis em estoque de cada loja: {string}")
